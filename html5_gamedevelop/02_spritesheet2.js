...
function drawSprite(spritename, posX, posY) {
    ...
    //
    // YOUR CODE HERE
		for (var spriteSheetKey in gSpriteSheets) {
			var spriteSheet = gSpriteSheets[spriteSheetKey];
...
function __drawSpriteInternal(spt, sheet, posX, posY) {
    ...
    // YOUR CODE HERE
		...
		//por algun motivo que no entiendo, quieren centrar los sprites en vez de ponerlos en top-left
		var hlf = {
			x: spt.cx,
			y: spt.cy
		};
